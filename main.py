...
class State(tk.Frame):
    ...
    def __init__(self,master=None,model=None):
        ...
        #王の指定(2つだけなので決め打ち宣言)
        self.Boad_dot[8][0].are_you_king = True
        self.Boad_dot[8][24].are_you_king = True
    ...
    def Player_turn(self,event):
        ...
        #選択された場所が盤面内かを確認
        if (self.Choice_x < 0 or self.Choice_x > 8 or self.Choice_y < 0 or self.Choice_y > 24):
        ...
        while True:
            ...
            if self.Boad_dot[self.Choice_x][self.Choice_y].are_you_king == True:
                ...
                if self.Choice_x == 0 and self.Choice_y == 0:
                    continue
                #赤色
                elif self.Choice_x == 0 and self.Choice_y == 24:
                    continue
    ...
    def Win_Check(self):
        ...
        #赤色(左下)   
            ...
            #決め打ち王チェック
            if self.Boad_dot[0][24].are_you_king != True:
                return False
            Count_True_Piece = 0           
            step = 0
            for i in reversed(range(0,6)):
